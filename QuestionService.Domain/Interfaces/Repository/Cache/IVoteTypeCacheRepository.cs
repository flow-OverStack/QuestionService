...
public interface IVoteTypeCacheRepository
{
    ...
    ///     If any vote types are missing, they are fetched using <paramref name="fetch"/> and cached.
    /// </summary>
    /// <param name="ids">A collection of long identifiers for the VoteType entities to retrieve.</param>
    /// <param name="fetch">A fallback delegate that fetches missing vote types by their identifiers.</param>
    ...
    Task<IEnumerable<VoteType>> GetByIdsAsync(IEnumerable<long> ids,
